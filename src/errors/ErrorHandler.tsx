import ErrorIllustartor from "@/animations/Error.json"
    ...
    <div className="fixed inset-0 flex items-center justify-center p-5 w-full">
      <div className="text-center">
        ...
        <div className="flex justify-center ">
          <Lottie className="w-80 h-80" animationData={ErrorIllustartor} />
        </div>

        <h2 className="text-[36px] font-bold lg:text-[50px] text-white">
          {statusCode} - {title}
        </h2>
        <p className="mt-5 lg:text-lg text-second">
        ...
        <div className="flex items-center justify-center space-x-4 my-10">
          <Link
            to={"/"}
            className="inline-block bg-second-dark p-2 font-medium text-white hover:!text-white rounded-md"
            reloadDocument
          >
            Home
          </Link>
